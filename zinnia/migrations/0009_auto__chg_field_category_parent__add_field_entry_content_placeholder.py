...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('zinnia_entry', 'content_placeholder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Placeholder'], null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('zinnia_entry', 'content_placeholder_id')
